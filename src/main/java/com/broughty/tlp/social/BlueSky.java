...
public class BlueSky {
    ...
    public String postMessage(ListeningParty listeningParty) throws IOException, URISyntaxException {
        ...
        System.out.println("Cid is " + response2.get().getCid());
        return listeningParty.listeningPartyNumber() + ";" + response2.get().getCid() + ";" + response2.get().getUri();
    }
